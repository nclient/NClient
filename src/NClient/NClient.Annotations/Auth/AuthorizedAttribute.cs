...
namespace NClient.Annotations.Auth
{
    ...
    public class AuthorizedAttribute : Attribute, IAuthorizedAttribute
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="AuthorizedAttribute" /> class.</summary>
        public AuthorizedAttribute()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="AuthorizedAttribute" /> class with the specified policy.</summary>
