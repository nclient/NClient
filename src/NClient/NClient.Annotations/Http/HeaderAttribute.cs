...
{
    /// <summary>Specifies that a method/methods should be use the request header.</summary>
    ...
    {
        /// <summary>Initializes a new <see cref="HeaderAttribute"/> with the given header.</summary>
