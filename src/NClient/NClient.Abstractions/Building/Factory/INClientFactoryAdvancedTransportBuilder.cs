...
namespace NClient
{
    public interface INClientFactoryAdvancedTransportBuilder
    {
        /// <summary>
        ...
        INClientFactoryAdvancedSerializationBuilder<TRequest, TResponse> UsingCustomTransport<TRequest, TResponse>(
