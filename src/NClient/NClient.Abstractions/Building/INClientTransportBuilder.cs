...
namespace NClient
{
    public interface INClientTransportBuilder<TClient> where TClient : class
    {
        /// <summary>Sets custom <see cref="ITransportProvider{TRequest,TResponse}"/> used to create instances of <see cref="ITransport{TRequest,TResponse}"/>.</summary>
        ...
        /// <param name="responseBuilderProvider">The provider that can create instances of <see cref="IResponseBuilderProvider{TRequest,TResponse}"/>.</param>
        INClientSerializationBuilder<TClient, TRequest, TResponse> UsingCustomTransport<TRequest, TResponse>(
