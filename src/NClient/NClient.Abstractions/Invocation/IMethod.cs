...
namespace NClient.Invocation
{
    public interface IMethod
    {
        ...
        /// <summary>
        /// Get <see cref="IPathAttribute"/> represents part of URI for method
        /// </summary>
        IPathAttribute? PathAttribute { get; }
        /// <summary>
        /// Get <see cref="IUseVersionAttribute"/>
        /// </summary>
        IUseVersionAttribute? UseVersionAttribute { get; }
        /// <summary>
        /// Get <see cref="ITimeoutAttribute"/> represents time limit for method execution 
        /// </summary>
        ITimeoutAttribute? TimeoutAttribute { get; }
        /// <summary>
        /// Get array of <see cref="IMetadataAttribute"/> represents additional method info (like headers for HTTP)
        /// </summary>
        IMetadataAttribute[] MetadataAttributes { get; }
        /// <summary>
        /// Get array of <see cref="IMethodParam"/> represents incoming parameters of operation
        /// </summary>
