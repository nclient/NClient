...
{
    /// <summary>System.Xml.XmlSerializer based provider for a component that can create <see cref="ISerializer"/> instances.</summary>
    public class SystemXmlSerializerProvider : ISerializerProvider
    {
        ...
        /// <summary>Creates the System.Xml.XmlSerializer based serializer provider.</summary>
