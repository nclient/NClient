...
namespace NClient.Tests.ClientTests
{
    ...
    public class BasicClientTest
    {
        ...
        public async Task BasicClient_GetAsync_IntInBody()
        {
            ...
            var result = await NClientGallery.Clients.GetRest().For<IBasicClientWithMetadata>(api.Urls.First().ToUri()).Build()
                .GetAsync(id);
        ...
        public async Task BasicClient_PostAsync_NotThrow()
        {
            ...
            await NClientGallery.Clients.GetRest().For<IBasicClientWithMetadata>(api.Urls.First().ToUri()).Build()
