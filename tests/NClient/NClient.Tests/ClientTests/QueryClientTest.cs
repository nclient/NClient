...
namespace NClient.Tests.ClientTests
{
    ...
    public class QueryClientTest
    {
        ...
        public async Task QueryClient_GetAsync_IntInBody()
        {
            ...
            var result = await NClientGallery.Clients.GetBasic().For<IQueryClientWithMetadata>(api.Urls.First()).Build()
                .GetAsync(id);
        ...
        public async Task QueryClient_PostAsync_NotThrow()
        {
            ...
            await NClientGallery.Clients.GetBasic().For<IQueryClientWithMetadata>(api.Urls.First()).Build()
