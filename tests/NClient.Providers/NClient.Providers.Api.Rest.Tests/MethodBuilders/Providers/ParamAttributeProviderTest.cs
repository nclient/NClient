...
namespace NClient.Providers.Api.Rest.Tests.MethodBuilders.Providers
{
    ...
    public class ParamAttributeProviderTest
    {
        ...
        {
            new TestCaseData(GetParamInfo<IImplicitQuery>(), new PropertyParamAttribute())
            ...
            new TestCaseData(GetParamInfo<IImplicitBody>(), new ContentParamAttribute())
            ...
            new TestCaseData(GetParamInfo<IOther>(), new PropertyParamAttribute())
                .SetName("With other"),
